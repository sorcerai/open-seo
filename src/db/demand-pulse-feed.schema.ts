...
export const demandPulseScores = sqliteTable(
  "demand_pulse_scores",
  {
    ...
    complianceBlocked: integer("compliance_blocked", { mode: "boolean" })
      .notNull()
      .default(false),
...
export const demandPulseFeedItems = sqliteTable(
...
export const demandPulseDecisions = sqliteTable(
  "demand_pulse_decisions",
  {
    ...
    publicationTriggered: integer("publication_triggered", {
      mode: "boolean",
    })
      .notNull()
      .default(false),
  ...
  (table) => [
    ...
    check(
      ...
      sql`${table.publicationTriggered} = 0`,
    ),
    check(
