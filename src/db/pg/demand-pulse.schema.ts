...
export const demandPulseProfiles = pgTable(
  "demand_pulse_profiles",
  {
    ...
    publicationDisabled: boolean("publication_disabled")
      .notNull()
      .default(true),
...
export const demandPulseSources = pgTable(
...
export const demandPulseRuns = pgTable(
  "demand_pulse_runs",
  {
    id: text("id").primaryKey(),
    profileId: text("profile_id")
...
export const demandPulseSourceRuns = pgTable(
