...
export const demandPulseFamilies = pgTable(
...
export const demandPulseFamilyEvidence = pgTable(
...
export const demandPulseCoverageChecks = pgTable(
  "demand_pulse_coverage_checks",
  {
    ...
    prefersExistingUpdate: boolean("prefers_existing_update")
      .notNull()
      .default(false),
