...
export const demandPulseObservations = pgTable(
...
export const demandPulseEvidenceEvents = pgTable(
...
export const demandPulseObservationEvents = pgTable(
...
export const demandPulseDuplicateEdges = pgTable(
